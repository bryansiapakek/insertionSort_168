...
int arr[20];													// MembuatbArray dengan panjang data 20
int n;															// Membuat Variable inputan n

void inpuy() {						// Procedure Input
	while (true)
	{
...
void insertionsort() {			// Procedure Insertiondort
...
void display() {		// Procedure Display
	...
	cout << "Elment Array yang telah tersusun" << endl;		// Output ke layar
	cout << "==================================" << endl;	// Output ke layar 

	for (int j = 0; j < n; j++) {					// Looping denganj dimualai dari 0 hingga ke n-1
